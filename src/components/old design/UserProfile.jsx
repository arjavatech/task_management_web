  ...
  return (
    <>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                className={profile.reminderSettings.enabled ? "" : ""}
                style={profile.reminderSettings.enabled ? {backgroundColor: '#fcd500', color: 'black'} : {}}
              >
          ...
          <CardContent className="space-y-4">
            <div className="flex gap-2">
              <Input
                ...
                className="flex-1"
              />
              <Button onClick={addCcEmail} disabled={!newCcEmail} style={{backgroundColor: '#fcd500', color: 'black'}} className="hover:bg-orange-600">
      ...
      <div className="flex justify-end">
        <Button onClick={handleSave} style={{backgroundColor: '#fcd500', color: 'black'}} className="hover:bg-orange-600">
          ...
          <Card className="bg-green-50 border-green-200">
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{backgroundColor: '#fcd500'}}>
                  <span className="text-black text-sm">✓</span>
                </div>
                <p className="text-black font-medium">Profile updated successfully!</p>
              </div>
            </CardContent>
          </Card>
        </div>
