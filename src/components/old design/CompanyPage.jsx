      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        <div className="flex flex-col lg:flex-row items-start lg:items-center space-y-4 sm:space-y-0 sm:space-x-4">
          <Link to="/companies" className="self-start">
            <Button size="lg" className="p-3 mb-3 mt-1" style={{backgroundColor: '#fcd500'}}>
          ...
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <Button onClick={() => setShowTaskForm(!showTaskForm)} size="sm" style={{backgroundColor: '#fcd500', color: 'black'}} className="hover:bg-orange-600">
