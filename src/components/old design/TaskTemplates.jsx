  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button onClick={() => setShowForm(true)} style={{backgroundColor: '#fcd500', color: 'black'}} className="hover:bg-orange-600 w-full sm:w-auto">
      ...
      >
        <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2 flex gap-3">
            ...
            <Button type="submit" style={{backgroundColor: '#fcd500', color: 'black'}} className="flex-1 hover:bg-orange-600">
              Create Template
            </Button>
          </div>
        </form>
      ...
      >
        <form onSubmit={handleAssign} className="space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <Button type="submit" style={{backgroundColor: '#fcd500', color: 'black'}} className="flex-1 hover:bg-orange-600" disabled={assignData.companyIds.length === 0}>
