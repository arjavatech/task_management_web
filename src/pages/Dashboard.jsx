      ...
      <div className="xl:hidden bg-white border-b border-gray-200 px-4 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Task overview</p>
          </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100 p-3 sm:p-6 hover:shadow-md transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div className="mb-2 sm:mb-0">
                <p className="text-xs sm:text-sm font-medium text-gray-500 mb-1 sm:mb-2">Total Companies</p>
                <p className="text-xl sm:text-3xl font-bold text-gray-900">{companies.length}</p>
              </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100 p-3 sm:p-6 hover:shadow-md transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div className="mb-2 sm:mb-0">
                ...
                <p className="text-xl sm:text-3xl font-bold text-gray-900">{completedTasks}</p>
                <p className="text-xs text-green-600 mt-1 font-medium">{completionRate}%</p>
              </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100 p-3 sm:p-6 hover:shadow-md transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div className="mb-2 sm:mb-0">
                ...
                <p className="text-xl sm:text-3xl font-bold text-gray-900">{inProgressTasks}</p>
              </div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100 p-3 sm:p-6 hover:shadow-md transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div className="mb-2 sm:mb-0">
                ...
                <p className="text-xl sm:text-3xl font-bold text-gray-900">{overdueTasks}</p>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link to="/companies" className="block">
              <div className="flex items-center gap-3 p-3 sm:p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <div>
                  <p className="text-sm sm:text-base font-medium text-gray-900">Manage Companies</p>
                  <p className="text-xs sm:text-sm text-gray-500">Add or edit company profiles</p>
                </div>
              </div>
            </Link>
            ...
            {companies.length > 0 && (
              <Link to={`/company/${companies[0].id}`} className="block">
                <div className="flex items-center gap-3 p-3 sm:p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div>
                    <p className="text-sm sm:text-base font-medium text-gray-900">Add New Task</p>
                    <p className="text-xs sm:text-sm text-gray-500">Create tasks for your companies</p>
                  </div>
                </div>
              </Link>
            )}
          ...
          <div className="border-b border-gray-200 p-4 sm:p-6">
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 mt-1">Task distribution across all companies</p>
              </div>
          ...
          <div className="p-4 sm:p-6">
            {companies.length === 0 ? (
              <div className="text-center py-8 sm:py-12">
                ...
                <p className="text-sm sm:text-base text-gray-500 mb-6">Add companies to see task distribution</p>
                <Link to="/companies">
                      ...
                      return (
                        <div key={company.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div className="text-center">
                              <p className="text-lg font-bold text-red-600">{overdueTasks}</p>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-900 flex items-center gap-2">
                      ...
                      <span className="hidden sm:inline">Tasks Due This Week</span>
                  ...
                  <div className="text-left sm:text-right">
                    <p className="text-xl sm:text-2xl font-bold text-gray-900">{tasksThisWeek.length}</p>
              ...
              <div className="p-4 sm:p-6">
                {tasksThisWeek.length === 0 ? (
                  <div className="text-center py-8 sm:py-12">
                    ...
                    <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2">No tasks due this week</h3>
                    <p className="text-sm sm:text-base text-gray-500">Enjoy your productive week!</p>
                  </div>
                ) : (
                    ...
                    {tasksThisWeek.map(task => {
                      ...
                      return (
                        <div key={task.id} className={`flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 rounded-lg border-l-4 hover:bg-gray-50 transition-colors gap-3 sm:gap-0 ${
                          ...
                          <div className="flex flex-row sm:flex-col lg:flex-row items-start sm:items-center gap-3 sm:gap-2 lg:gap-3">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between py-2 border-b border-gray-100">
                  <span className="text-sm sm:text-base text-gray-600">Total Tasks</span>
                  <span className="font-semibold text-gray-900">{totalTasks}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-gray-100">
                ...
                <div className="flex items-center justify-between py-2 border-b border-gray-100">
                  <span className="text-sm sm:text-base text-gray-600">In Progress</span>
                  <span className="font-semibold text-blue-600">{inProgressTasks}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-gray-100">
                ...
                <div className="pt-3 sm:pt-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm sm:text-base font-medium text-gray-600">Completion Rate</span>
                    <span className="font-bold text-gray-900">{completionRate}%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2 sm:h-3">
                    <div 
                      className="h-2 sm:h-3 bg-slate-900 rounded-full transition-all duration-300" 
